...
enum MenuState
{
    MENU_WELCOME,
    MENU_SHOW_SETTINGS,
    MENU_WAIT_FOR_COMMAND,
    MENU_CHANGE_SETTING,
    MENU_CONFIRM_DELETE,
    MENU_EXIT,
};

extern bool deviceMenuActive;
extern void deleteConfig();
extern void saveToSpiffs();
extern void printConfigFile();
extern void printSettings();

MenuState currentState = MENU_WELCOME;

void deviceMenu(const char *command)
{
    deviceMenuActive = true;
    static int settingToChange = -1;
    static bool waitingForConfirmation = false;
    int option = 0;

    if (currentState == MENU_WELCOME)
    {
        printSettings();
        currentState = MENU_WAIT_FOR_COMMAND;
        return;
    }

    switch (currentState)
    {
    case MENU_WAIT_FOR_COMMAND:
        ...
        if (strlen(command) == 0 || (option = atoi(command)) == 0)
        {
        ...
        if (option == 81)
        {
            ...
            currentState = MENU_CONFIRM_DELETE;
            return;
        }
        ...
        settingToChange = option;
        Serial0.println("Enter the new value for the selected setting:");
        currentState = MENU_CHANGE_SETTING;
        break;

    case MENU_CHANGE_SETTING:
        if (settingToChange != -1)
        {
            ...
            case 8:
                ...
                break;
            case 9:
                usbAttributes = newValue;
                break;
            case 10:
                descriptor4 = newValue;
                break;
            case 14:
                deviceDescriptor_bLength = newValue.toInt();
                break;
            case 15:
                deviceDescriptor_bDescriptorType = newValue.toInt();
                break;
            case 16:
                deviceDescriptor_bcdUSB = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 17:
                deviceDescriptor_bDeviceClass = newValue.toInt();
                break;
            case 18:
                deviceDescriptor_bDeviceSubClass = newValue.toInt();
                break;
            case 19:
                deviceDescriptor_bDeviceProtocol = newValue.toInt();
                break;
            case 20:
                deviceDescriptor_bMaxPacketSize0 = newValue.toInt();
                break;
            case 21:
                deviceDescriptor_idVendor = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 22:
                deviceDescriptor_idProduct = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 23:
                deviceDescriptor_bcdDevice = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 24:
                deviceDescriptor_iManufacturer = newValue.toInt();
                break;
            case 25:
                deviceDescriptor_iProduct = newValue.toInt();
                break;
            case 26:
                deviceDescriptor_iSerialNumber = newValue.toInt();
                break;
            case 27:
                deviceDescriptor_bNumConfigurations = newValue.toInt();
                break;
            case 28:
                configurationDescriptor_bLength = newValue.toInt();
                break;
            case 29:
                configurationDescriptor_bDescriptorType = newValue.toInt();
                break;
            case 30:
                configurationDescriptor_wTotalLength = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 31:
                configurationDescriptor_bNumInterfaces = newValue.toInt();
                break;
            case 32:
                configurationDescriptor_bConfigurationValue = newValue.toInt();
                break;
            case 33:
                configurationDescriptor_iConfiguration = newValue.toInt();
                break;
            case 34:
                configurationDescriptor_bmAttributes = newValue.toInt();
                break;
            case 35:
                configurationDescriptor_MaxPower = newValue.toInt();
                break;
            case 36:
                interfaceDescriptor0_bLength = newValue.toInt();
                break;
            case 37:
                interfaceDescriptor0_bDescriptorType = newValue.toInt();
                break;
            case 38:
                interfaceDescriptor0_bInterfaceNumber = newValue.toInt();
                break;
            case 39:
                interfaceDescriptor0_bAlternateSetting = newValue.toInt();
                break;
            case 40:
                interfaceDescriptor0_bNumEndpoints = newValue.toInt();
                break;
            case 41:
                interfaceDescriptor0_bInterfaceClass = newValue.toInt();
                break;
            case 42:
                interfaceDescriptor0_bInterfaceSubClass = newValue.toInt();
                break;
            case 43:
                interfaceDescriptor0_bInterfaceProtocol = newValue.toInt();
                break;
            case 44:
                interfaceDescriptor0_iInterface = newValue.toInt();
                break;
            case 45:
                hidDescriptor0_bLength = newValue.toInt();
                break;
            case 46:
                hidDescriptor0_bDescriptorType = newValue.toInt();
                break;
            case 47:
                hidDescriptor0_bcdHID = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 48:
                hidDescriptor0_bCountryCode = newValue.toInt();
                break;
            case 49:
                hidDescriptor0_bNumDescriptors = newValue.toInt();
                break;
            case 50:
                hidDescriptor0_bDescriptorType0 = newValue.toInt();
                break;
            case 51:
                hidDescriptor0_wDescriptorLength = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 52:
                endpointDescriptor0_bLength = newValue.toInt();
                break;
            case 53:
                endpointDescriptor0_bDescriptorType = newValue.toInt();
                break;
            case 54:
                endpointDescriptor0_bEndpointAddress = newValue.toInt();
                break;
            case 55:
                endpointDescriptor0_bmAttributes = newValue.toInt();
                break;
            case 56:
                endpointDescriptor0_wMaxPacketSize = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 57:
                endpointDescriptor0_bInterval = newValue.toInt();
                break;
            case 58:
                interfaceDescriptor1_bLength = newValue.toInt();
                break;
            case 59:
                interfaceDescriptor1_bDescriptorType = newValue.toInt();
                break;
            case 60:
                interfaceDescriptor1_bInterfaceNumber = newValue.toInt();
                break;
            case 61:
                interfaceDescriptor1_bAlternateSetting = newValue.toInt();
                break;
            case 62:
                interfaceDescriptor1_bNumEndpoints = newValue.toInt();
                break;
            case 63:
                interfaceDescriptor1_bInterfaceClass = newValue.toInt();
                break;
            case 64:
                interfaceDescriptor1_bInterfaceSubClass = newValue.toInt();
                break;
            case 65:
                interfaceDescriptor1_bInterfaceProtocol = newValue.toInt();
                break;
            case 66:
                interfaceDescriptor1_iInterface = newValue.toInt();
                break;
            case 67:
                hidDescriptor1_bLength = newValue.toInt();
                break;
            case 68:
                hidDescriptor1_bDescriptorType = newValue.toInt();
                break;
            case 69:
                hidDescriptor1_bcdHID = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 70:
                hidDescriptor1_bCountryCode = newValue.toInt();
                break;
            case 71:
                hidDescriptor1_bNumDescriptors = newValue.toInt();
                break;
            case 72:
                hidDescriptor1_bDescriptorType0 = newValue.toInt();
                break;
            case 73:
                hidDescriptor1_wDescriptorLength = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 74:
                endpointDescriptor1_bLength = newValue.toInt();
                break;
            case 75:
                endpointDescriptor1_bDescriptorType = newValue.toInt();
                break;
            case 76:
                endpointDescriptor1_bEndpointAddress = newValue.toInt();
                break;
            case 77:
                endpointDescriptor1_bmAttributes = newValue.toInt();
                break;
            case 78:
                endpointDescriptor1_wMaxPacketSize = strtoul(newValue.c_str(), NULL, 16);
                break;
            case 79:
                endpointDescriptor1_bInterval = newValue.toInt();
                break;
            }
